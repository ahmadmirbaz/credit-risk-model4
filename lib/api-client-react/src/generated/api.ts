 ...
 */
export const getPredictCreditRiskUrl = () => {
  return `/api/credit-risk/predict`;
};
...
export const predictCreditRisk = async (
  ...
  return customFetch<CreditRiskResult>(getPredictCreditRiskUrl(), {
    ...options,
    method: "POST",
...
export const getPredictCreditRiskMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof predictCreditRisk>>,
    TError,
  ...
  TContext
> => {
  const mutationKey = ["predictCreditRisk"];
  ...
  > = (props) => {
    ...
    return predictCreditRisk(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type PredictCreditRiskMutationResult = NonNullable<
  Awaited<ReturnType<typeof predictCreditRisk>>
>;
export type PredictCreditRiskMutationBody = BodyType<LoanApplication>;
export type PredictCreditRiskMutationError = ErrorType<unknown>;

/**
 * @summary Predict loan default probability
 */
export const usePredictCreditRisk = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getPredictCreditRiskMutationOptions(options));
};

/**
 * @summary Get prediction history
 */
export const getGetCreditRiskHistoryUrl = () => {
  return `/api/credit-risk/history`;
};

export const getCreditRiskHistory = async (
  options?: RequestInit,
): Promise<CreditRiskRecord[]> => {
  return customFetch<CreditRiskRecord[]>(getGetCreditRiskHistoryUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetCreditRiskHistoryQueryKey = () => {
  return [`/api/credit-risk/history`] as const;
};

export const getGetCreditRiskHistoryQueryOptions = <
  TData = Awaited<ReturnType<typeof getCreditRiskHistory>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getCreditRiskHistory>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetCreditRiskHistoryQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getCreditRiskHistory>>
  > = ({ signal }) => getCreditRiskHistory({ signal, ...requestOptions });
...
export type GetCreditRiskHistoryQueryResult = NonNullable<
  Awaited<ReturnType<typeof getCreditRiskHistory>>
>;
export type GetCreditRiskHistoryQueryError = ErrorType<unknown>;

/**
 * @summary Get prediction history
 */

export function useGetCreditRiskHistory<
  TData = Awaited<ReturnType<typeof getCreditRiskHistory>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetCreditRiskHistoryQueryOptions(options);
...
export const getGetModelInfoUrl = () => {
  return `/api/credit-risk/model-info`;
};
...
export const getGetModelInfoQueryKey = () => {
  return [`/api/credit-risk/model-info`] as const;
};
